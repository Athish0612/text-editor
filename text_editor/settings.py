...
ALLOWED_HOSTS = ["https://pythontexteditor.azurewebsites.net"]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pythontexteditor-database',
        'HOST': 'pythontexteditor-server.postgres.database.azure.com',
        'USER': 'xmvhecilkz',
        'PASSWORD': 'Q5BPG1Z75047YMA8$',
